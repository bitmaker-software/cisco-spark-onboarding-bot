...
const gdrive = require('../integrations/gdrive.js');
              ...
              request({
                ...
                if (step.document_step !== null) {
                  if (step.document_step.upload_dir !== null) {
                    gdrive.uploadToDrive(flow.ownerId, file_info, body, step.document_step.upload_dir, function(file) {
        ...
        if (step.step_type_id === STATUS_TYPES.STEP_TYPES.DOWNLOAD_FROM_BOT || step.step_type_id === STATUS_TYPES.STEP_TYPES.DOWNLOAD_FROM_BOT_AND_UPLOAD_BACK) {
          ...
          if (step.document_step !== null) {
            ...
            if (documentUrl !== null) {
              ...
              gdrive.getDriveDocument(flow.ownerId, documentUrl, stream => {
                step.stream = stream;
                if (index === stepsMax) {
